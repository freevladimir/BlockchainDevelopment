...
contract SimpleCoinToken is BurnableToken, Ownable{
    ...
    uint256 public totalSupply = 100 * 1 ether;
...
contract Crowdsale is Ownable {
    ...
    function Crowdsale(SimpleCoinToken _token) {
        token = _token;
        multisig = 0xAc8ACe90B02323A86cD17e96092434fc24031890;
        restricted = 0xAc8ACe90B02323A86cD17e96092434fc24031890;
    ...
    function createTokens() saleIsOn payable {
        ...
        token.transferFrom(owner, msg.sender, tokensWithBonus);

        uint restrictedTokens = tokens.mul(restrictedPercent).div(100 - restrictedPercent);
        token.transferFrom(owner, restricted, restrictedTokens);
        ...
        if(msg.data.length == 20) {
            ...
            // начисляем рефереру
            token.transferFrom(owner, referer, refererTokens);
        }
    }
